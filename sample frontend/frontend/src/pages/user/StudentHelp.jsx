...
function HelpSection({ title, icon, children }) {
  return (
    <Paper elevation={0} sx={{ p: 4, mb: 4, borderRadius: 4, border: '1px solid #e2e8f0', bgcolor: 'white' }}>
  ...
  return (
    <Box sx={{ pb: 8 }}>
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={0} sx={{ p: 4, borderRadius: 4, border: '2px solid', borderColor: 'primary.main', bgcolor: 'primary.50' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
